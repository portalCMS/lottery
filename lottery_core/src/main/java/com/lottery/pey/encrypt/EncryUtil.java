package com.lottery.pey.encrypt;
...
import com.lottery.pey.encrypt.AES;
import com.lottery.pey.encrypt.Digest;
import com.lottery.pey.encrypt.RSA;
...
public class EncryUtil {
	 ...
	 * @return
	 */
	public static boolean verifyCallback(String hmac, String sValue, String keyValue) {
		String sNewString = null;
		sNewString = DigestUtil.hmacSign(sValue, keyValue);
