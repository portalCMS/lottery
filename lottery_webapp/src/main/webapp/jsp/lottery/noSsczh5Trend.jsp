...
<title>五星综合号码走势图</title>
<%@ include file="../include/css_asset.jsp"%>
<%@ include file="../include/js_asset.jsp"%>
<link href="${contextPath }/jsp/css/notrend.css" rel="stylesheet"
	type="text/css" />
<script src="${contextPath }/jsp/lottery/js/notrend/noSsczh5Trend.js"></script>
</head>
<body>
		...
		<div class="clearfix mt15 ">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<thead>
					<tr class="_noTrendTh">
						...
						<td align="center" valign="middle" colspan="10">开奖号码跨度</td>
						<td align="center" valign="middle" colspan="6">开奖号码大小比</td>
						<td align="center" valign="middle" colspan="6">开奖号码单双比</td>
						<td align="center" valign="middle" colspan="6">开奖号码质和比</td>
					...
					<tr class="_noTr">
						...
						<td align="center" valign="middle" class="_analog">5:0</td>
						<td align="center" valign="middle" class="_analog">4:1</td>
						<td align="center" valign="middle" class="_analog">3:2</td>
						<td align="center" valign="middle" class="_analog">2:3</td>
						<td align="center" valign="middle" class="_analog">1:4</td>
						<td align="center" valign="middle" class="_analog">0:5</td>
				...
				<td align="center" valign="middle" class="_dxb"
				...
				<tr class="_hidLineTr" style="display: none;">
					<td colspan="51" style="height: 2px;background-color: #BDB7B7"></td>
				</tr>
				<thead>
					<tr class="_noTrendTh">
						<td align="center" valign="middle" rowspan="2">期号</td>
			...
			<div class="p20">
				...
				<ul class="mt5">
					...
					<li class="mt5">[最大连出值] 单个开奖号码连续出现的期数值，称为该号码的连出值。当前查询中，本列连出值中的最大值就是“最大连出值”</li>
