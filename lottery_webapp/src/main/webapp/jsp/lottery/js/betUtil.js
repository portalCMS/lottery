	...
	return{
		...
		chasePeriodHelper:function(num,b,bv,dt){	
		 ...
		 winAmountChange2:function(){
			 ...
			 $("i").each(function (){
			    $(this).find("span").each(function(index){
			    	...
			    	var dataType =  $(".ssc-type-choose:visible")
									.find("input[type='radio']:checked").attr("data-type")+"";
			    	var amountArr = winAmounts.split(",");
			    	var winAmount = amountArr[index];
			    	if(dataType.indexOf("不含对子")>-1){
			    		winAmount = amountArr[1];
			    	}
		 ...
		 hotMissNumCount:function(){
			 this.checkboxMiss();
			 this.checkboxHot();
			 if(!$("#missing").prop('checked') && !$("#hotcold").prop('checked')){
			 ...
			 if(curId=="SSC_1_1"||curId=="SSC_2_1"||curId=="SSC_3_1"||curId=="SSC_4_1"||curId=="SSC_5_1"
	            ...
	            // 标准选号, 6_3为通选
				 curType = "zx";
		            ...
		            // 后三星直选和值
		            curType = "h3zs";
		        }else if("SSC_11_2"==curId){
		        	 // 前三星直选和值
		            curType = "q3zs";
		        }else if("SSC_12_2"==curId){
		        	 // 中三星直选和值
		            curType = "z3zs";
		        }else if("SSC_4_3"==curId){
		            // 后三星组三和值
		            curType = "h3z3s";
		        }else if("SSC_15_3"==curId){
		            // 中三星组三和值
		            curType = "z3z3s";
		        }else if("SSC_13_3"==curId){
		            // 前三星组三和值
		            curType = "q3z3s";
		        }else if("SSC_4_6"==curId){
		            // 后三星组六和值
		            curType = "h3z6s";
		        }else if("SSC_16_2"==curId){
		            // 中三星组六和值
		            curType = "z3z6s";
		        }else if("SSC_14_2"==curId){
		            // 前三星组六和值
		            curType = "q3z6s";
		            ...
		            // 前二星包号
		            curType = "q2bh";
		        }else if("SSC_4_2"==curId||"SSC_4_5"==curId){
		            // 后三星包号
		            curType = "h3bh";
		        }else if("SSC_15_2"==curId||"SSC_16_1"==curId){
		            // 中三星包号
		            curType = "z3bh";
		        }else if("SSC_13_2"==curId||"SSC_14_1"==curId){
		            // 前三星包号
		            curType = "q3bh";
		            ...
		            // 前二星胆拖
		            curType = "q2dt";
		        }else if("SSC_3_3"==curId||"SSC_4_7"==curId){
		            // 后三星胆拖
		            curType = "h3dt";
		        }else if("SSC_12_3"==curId||"SSC_16_3"==curId){
		            // 中三星胆拖
		            curType = "z3dt";
		        }else if("SSC_11_3"==curId||"SSC_14_3"==curId){
		            // 前三星胆拖
		            curType = "q3dt";
		        }else if("SSC_3_4"==curId){
		            // 后三跨度
		            curType = "h3kd";
		        }else if("SSC_12_4"==curId){
		            // 中三跨度
		            curType = "z3kd";
		        }else if("SSC_11_4"==curId){
		            // 前三跨度
		            curType = "q3kd";
		        }else if("SSC_19_1"==curId){
		            // 组选120
		            curType = "zx120";
		        }else if("SSC_19_2"==curId){
		            // 组选60
		            curType = "zx60";
		        }else if("SSC_19_3"==curId){
		            // 组选30
		            curType = "zx30";
		        }else if("SSC_19_4"==curId){
		            // 组选30
		            curType = "zx20";
		        }else if("SSC_19_5"==curId){
		            // 组选30
		            curType = "zx10";
		        }else if("SSC_19_6"==curId){
		            // 组选30
		            curType = "zx5";
		        }else if("SSC_20_1"==curId){
		            // 组选24
		            curType = "zx24";
		        }else if("SSC_20_2"==curId){
		            // 组选12
		            curType = "zx12";
		        }else if("SSC_20_3"==curId){
		            // 组选6
		            curType = "zx6";
		        }else if("SSC_20_4"==curId){
		            // 组选4
		            curType = "zx4";
		        }else if(/5_2|2_2|3_5|4_(4|8)|6_(2|4)/.test(curId)){
		            // 手工录入
		            curType = "text";
		        }else if("SSC_7_1"==curId){
		            // 大小单双
		            curType = "h2dxds";
		        }else if("SSC_17_1"==curId){
		            // 大小单双
		            curType = "q2dxds";
		        }else if(/10_1/.test(curId)){
		            // 前三不定位一码
		            curType = "q3bd1";
		        }else if(/10_2/.test(curId)){
		            // 中三不定位一码
		            curType = "z3bd1";
		        }else if(/10_3/.test(curId)){
		            // 后三不定位一码
		            curType = "h3bd1";
		        }else if(/10_4/.test(curId)){
		            // 前三不定位二码
		            curType = "q3bd2";
		        }else if(/10_5/.test(curId)){
		            // 中三不定位二码
		            curType = "z3bd2";
		        }else if(/10_6/.test(curId)){
		            // 后三不定位二码
		            curType = "h3bd2";
		        }else{
		        	curType = "rx";
		 ...
		 refreshSSCHMCount:function(data){
			...
			if(/11_1|13_1|18_1|17_1/.test(curId)){
				...
				//显示总期数中的号码冷热
				 ...
				 for(var i=1;i<4;i++){
					 for(var j=0;j<15;j++){
						 var key = i+"_"+$item.eq(i-1).find("span").eq(j+1).find("strong").html();
						 for(var k=0;k<mList.length;k++){
							 if(key==mList[k].key){
								 $item.eq(i-1).find("span").eq(j+1).find("em:first").html(mList[k].value);
								 break;
							 }
						 }
					 }
				...
				//显示总期数中的号码冷热
				 ...
				 for(var i=1;i<4;i++){
					 for(var j=0;j<15;j++){
						 var key = i+":"+$item.eq(i-1).find("span").eq(j+1).find("strong").html();
						 for(var k=0;k<hList.length;k++){
							 if(key==hList[k].key){
								 $item.eq(i-1).find("span").eq(j+1).find("em:last").html(hList[k].value);
								 break;
							 }
						 }
					 }
...
//			$("._lottery_win_desc_btn").trigger("click");
