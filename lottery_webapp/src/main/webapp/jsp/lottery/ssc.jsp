...
<link href="${contextPath }/jsp/lottery/css/lottery.css" rel="stylesheet" type="text/css" />
<link href="${contextPath }/jsp/lottery/css/ssc.css" rel="stylesheet"
	type="text/css" />
<script type="text/javascript"
		src="${contextPath }/jsp/lottery/js/ssc/config.js"></script>
	<script type="text/javascript"
		src="${contextPath }/jsp/js/ssc/initssc.js"></script>
	<script type="text/javascript" 
		src="${contextPath }/jsp/lottery/js/betUtil.js"></script>
	<script type="text/javascript"
		src="${contextPath }/jsp/lottery/js/ssc/main.js"></script>
	<script type="text/javascript"
		src="${contextPath }/jsp/lottery/js/lock_number.js"></script>
	<script type="text/javascript" src="${contextPath }/jsp/lottery/js/sscKeyManager.js"></script>
	<script type="text/javascript" src="${contextPath }/jsp/lottery/js/lottery.js"></script>
	<script type="text/javascript"
	...
	<span id="wingScroll" class="fl wing_order_div">
		...
		<div class="iBox1 clearfix" style="display:none;">
			<div class="_titleInfo">
				<p>
					<input id="lotGroup" type="hidden" value="${lotteryGroup }"/>
					<input id="lotCode" type="hidden" value="${lotteryCode }"/>
					<input id="endBetTime" type="hidden" value="${task.endBetTime }"/>
					<span id="totalMinutes" class="color_red">${totalMunites }</span>分钟一期，
					全天<span id="totalTimes" class="color_red">${totalTimes }</span>期。<br>
					首期开奖<span id="startTime" class="color_red">${startTime }</span>，
					末期开奖<span id="endTime" class="color_red">${endTime }</span>。
					<!-- 设置最近的开奖记录期号，方便判断是否需要刷新开奖记录的轮询。 -->
					<input type="hidden" id="lastAwardNo" value="${lastAwardNo}">
				</p>
			</div>
		</div>
		<div class="clearfix _sscMainBg">
					<!-- 时时彩的容器，你可以给下面任何的 DIV 添加外层标签，并修改他们的样式，
						内嵌标签可能会被 `.html()` 函数给重置，故不建议在诸如 `div.ssc-num` 中内嵌标签. -->
					<div class="ssc-box" id="ssc">
						...
						<div class="ssc-main">
							...
							<!-- Choose boll with text -->
							<div class="ssc-main-choose-text" id="text_input">
								<span>
									...
									<span class="ml30 color_8d">『提醒』每注号码以<span class="color_green">"逗号","空格","分号"</span>分离。</span>
								</span>
...
<!-- 								<a href="#">清空列表</a>  -->
		...
		<div class="g-play-left">
				<div id="issueInfo" class="g-play-left-clock _issueInfo">
	                <h1>${lotteryName }-<b id="currentIssno">${task.lotterySeries }</b>期</h1>
	        ...
	        <div class="g-play-left-trend">
                <ul>
                    <li>
                        <i></i>
                        <a href="initSSCNoTrend.html?lotteryCode=${lotteryCode }" target="_blank">五星基本走势图</a>
                        <a href="initSSCzh5NoTrend.html?lotteryCode=${lotteryCode }" target="_blank">五星综合走势图</a>
                    </li>
                    <li>
                        <i></i>
                        <a href="initSSC3NoTrend_q.html?lotteryCode=${lotteryCode }" target="_blank">前三基本走势图</a>
                        <a href="initSSC3NoTrend_z.html?lotteryCode=${lotteryCode }" target="_blank">中三基本走势图</a>
                    </li>
                    <li>
                        <i></i>
                        <a href="initSSC3NoTrend.html?lotteryCode=${lotteryCode }" target="_blank">后三基本走势图</a>

                    </li>
                    <li>
                        <i></i>
                        <a href="initSSC2NoTrend_q.html?lotteryCode=${lotteryCode }" target="_blank">前二基本走势图</a>
                        <a href="initSSC2NoTrend.html?lotteryCode=${lotteryCode }" target="_blank">后二综合走势图</a>
                    </li>
                </ul>
            </div>
				<div class="mt10">
