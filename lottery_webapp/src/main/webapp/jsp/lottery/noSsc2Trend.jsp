...
<link href="${contextPath }/jsp/css/notrend.css" rel="stylesheet"
	type="text/css" />
<script src="${contextPath }/jsp/lottery/js/notrend/noSsc2Trend.js"></script>
</head>
<body>
<%-- 	<%@ include file="../include/head.jsp"%> --%>
	<input id="noType" type="hidden" value="h2">
	<!-- content -->
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<thead>
					<tr class="_noTrendTh">
						...
						<td align="center" valign="middle" colspan="10">十位号码分布</td>
						<td align="center" valign="middle" colspan="10">个位号码分布</td>
						<td align="center" valign="middle" colspan="10">跨度分布</td>
						<td align="center" valign="middle" colspan="2">对子</td>
					...
					<tr class="_noTr">
						...
						<td align="center" valign="middle" class="_analog">是</td>
						<td align="center" valign="middle" class="_analog">否</td>
				...
				<td align="center" valign="middle" class="_allnum_group"
					style="display: none;">0</td>
				<td align="center" valign="middle" class="_dz"
					style="display: none;">0</td>
				...
				<tr class="_hidLineTr" style="display: none;">
					<td colspan="45" style="height: 2px;background-color: #BDB7B7"></td>
				</tr>
				<thead>
					<tr class="_noTrendTh">
						<td align="center" valign="middle" rowspan="2">期号</td>
