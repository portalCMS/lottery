...
<link href="${contextPath }/jsp/lowlottery/css/lottery.css" rel="stylesheet" type="text/css" />
<link href="${contextPath }/jsp/lowlottery/css/ssc.css" rel="stylesheet"
	type="text/css" />
<script type="text/javascript"
		src="${contextPath }/jsp/lowlottery/js/ssc/config.js"></script>
	<script type="text/javascript"
		src="${contextPath }/jsp/js/low/initssc.js"></script>
	<script type="text/javascript" 
		src="${contextPath }/jsp/lowlottery/js/betUtil.js"></script>
	<script type="text/javascript"
		src="${contextPath }/jsp/lowlottery/js/ssc/main.js"></script>
	<script type="text/javascript"
		src="${contextPath }/jsp/lowlottery/js/lock_number.js"></script>
		<script type="text/javascript"
