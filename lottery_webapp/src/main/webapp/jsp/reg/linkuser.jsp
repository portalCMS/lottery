...
<script src="${contextPath }/jsp/js/reg/linkuser.js"></script>
</head>
<body>
		...
		<div class="findPwBox">
			<div class="clearfix hidden">
				<div class="pl20 fl">
					...
					<p class="line4 mt5"></p>
					<ul class="mt25">
						<li class="hintText"><div id="errorDiv" class="formListDiv f14 errorHint">
							<input type="hidden" id="parentId" class="_formvalue" value="${parentId }"/>
							<input type="hidden" id="quota" class="_formvalue" value="${quota }"/>
							<input type="hidden" id="idsTree" class="_formvalue" value="${memberType }"/>
							<input type="hidden" id="link" class="_formvalue" value="${link }"/>
						</div></li>
						<li class="clearfix mt10 f14 lh40"><span class="formListSpan">用   户    名：</span>
							<div class="formListDiv">
								<span class="maxInput"><span>
								<input type="text" id="customerName" value="${uservo.customerName }" name="customerName" class="_formvalue" style="width: 230px;" /></span></span>
