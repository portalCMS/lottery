			...
			<div class="pageFrBox_1">
				...
				<div class="p10 order_detail">
					<ul class="p20">
						...
						<li>转出资金用户：<a href="javascript:;" class="color_blue">${order.rsvst1 }</a></li>
						<li>获得资金用户：<a href="javascript:;" class="color_blue">${order.rsvst2 }</a></li>
