			...
			<div class="pageFrBox_1">
				...
				<div class="p10 order_detail">
					<ul class="p20">
						...
						<li>投注用户：<span class="color_blue">${order.rsvst4 }</span>
						</li>
						<li>投注订单：<span class="color_blue">${order.rsvst1 }</span>
						</li>
						<li>投注金额：<span class="color_red _amount">${order.rsvdc5 }</span>
						</li>
						<li>等级点差：<span class="color_red">${order.rsvdc4 }</span>
						</li>
