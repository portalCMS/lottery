...
<script src="${contextPath }/jsp/js/finance/edit_card.js"></script>
...
$(document).ready(function(){
	...
	$("#selectBank").val("${bankCard.bankId}");
});
</script>
</head>
<body>
	...
	<div class="container">
		<ol class="breadcrumb">
			...
			<li><a href="${contextPath }/index.do">财务管理</a></li>
			<li><a href="${contextPath }/showBankManage.do">银行卡管理</a></li>
			<li class="active">修改银行卡信息</li>
		</ol>
		...
		<div class="panel panel-default">
			<div class="panel-heading">修改银行卡信息</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-sm-6">
						<form class="form-horizontal" role="form" id="bankCardForm" method="post"  action="updateBankCard.do">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="hidden" class="form-control" id="id" name="id" value="${bankCard.id}">
									<input type="text" class="form-control" id="branceBankName" name="branceBankName" value="${bankCard.branceBankName }">
								</div>
							</div>
							<div class="form-group">
								<label for="address" class="col-sm-2 control-label">支行地址</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="bankcardAddress" name="bankcardAddress" value="${bankCard.bankcardAddress }">
								</div>
							</div>
							<div class="form-group">
								<label for="address" class="col-sm-2 control-label">开户名</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="opencardName" name="opencardName" value="${bankCard.opencardName }">
								</div>
							</div>
							<div class="form-group">
								<label for="address" class="col-sm-2 control-label">银行账号</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="cardNo" name="cardNo" value="${bankCard.cardNo }">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									<input type="hidden" id="cardInventoryId" name="cardInventoryId" value="${bankCard.cardInventoryId }"/>
								</div>
								<div class="col-sm-3">
									...
									<input type="hidden" id="cardLevel" name="cardLevel" value="${bankCard.cardLevel }"/>
								</div>
							</div>
							<div class="form-group">
								<label for="bz" class="col-sm-2 control-label">备注</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="remark" name="remark" value="${bankCard.remark }">
								</div>
							</div>
							<div class="split"></div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<button type="button" class="btn btn-danger"
											onclick="return submitForm()">确定修改</button>
								</div>
							</div>
						</form>
					</div>
