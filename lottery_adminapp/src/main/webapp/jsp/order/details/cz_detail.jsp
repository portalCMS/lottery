		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="form-group">
						<label class="control-label col-sm-1">充值方式</label>
						<c:if test="${ordervo.orderDetailType == 18009 }">
							<div class="form-control-static col-sm-10">银行充值</div>
						</c:if>
						<c:if test="${ordervo.orderDetailType == 18019 }">
							<div class="form-control-static col-sm-10">第三方充值</div>
						</c:if>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-sm-1">订单备注</label>
						<div class="form-control-static col-sm-10">
							<span class="text-danger">${ordervo.remark }</span>
						</div>
					</div>
					<div class="form-group">
