			...
			<div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="form-control-static col-sm-10">资金转入</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-1">转出用户</label>
						<div class="form-control-static col-sm-10">
							<a href="user/showUserInfo/${ordervo.fromCustomerId }.do">${ordervo.customerNameOut }</a>
						</div>
					</div>
