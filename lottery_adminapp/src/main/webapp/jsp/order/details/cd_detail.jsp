			...
			<div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="form-control-static col-sm-10">撤单返款</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-1">撤单类型</label>
						<c:if test="${ordervo.orderDetailType==18004 || ordervo.orderDetailType==18018 }">
							<div class="form-control-static col-sm-10">用户撤单</div>
						</c:if>
						<c:if test="${ordervo.orderDetailType==18006 }">
							<div class="form-control-static col-sm-10">系统撤单</div>
						</c:if>
					</div>
					<div class="form-group">
