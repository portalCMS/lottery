			...
			<div class="panel-body">
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="form-control-static col-sm-10">投注盈利</div>
					</div>
			...
			<div class="panel-body">
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="form-control-static col-sm-10">
							<a href="user/showUserInfo/${refid }.do">${refname }</a>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-1">订单编号</label>
						<div class="form-control-static col-sm-10">
							<a href="#">${ordervo.rsvst1 }</a>
						</div>
					</div>

					<div class="form-group">
						<label class="control-label col-sm-1">用户点差</label>
						<div class="form-control-static col-sm-10">
