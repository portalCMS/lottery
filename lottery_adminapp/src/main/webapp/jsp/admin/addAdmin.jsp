...
<script src="${contextPath }/jsp/js/admin/addAdmin.js"></script>
</head>
<body>
					...
					<div class="col-sm-6 ">
						<div class="form-horizontal" role="form">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" id="adminName" value="${auvo.adminName }">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="password" class="form-control" id="adminPwd" value="${auvo.adminPwd}"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="password" class="form-control" id="adminRolePwd" value="${auvo.adminRolePwd}"/>
								</div>
							</div>
						...
						<div class="form-horizontal">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<button type="submit" class="btn btn-danger _addBtn">确定增加</button>
								</div>
							</div>
						</div>
					</div>
