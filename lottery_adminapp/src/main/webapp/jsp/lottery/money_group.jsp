				...
				<div id="add_money_locak_panel">
					...
					<div class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control uname" checkType="isNotEmpty" alt="别名不能为空"
									name="addParam" id="name" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-1">理论返奖</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" id="atheory" value="2000" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control amoney" name="addParam"
									id="rebates" checkType="isNotEmpty,decmal6" alt="返奖率不能为空,返奖率必须是小数"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control amoney" name="addParam"
									id="payoutRatio" checkType="isNotEmpty,decmal6" alt="返点率不能为空,返点率必须是小数"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control amoney" name="addParam"
									id="margin" checkType="isNotEmpty,decmal6" alt="利润率不能为空,利润率必须是小数"/>
							</div>
				...
				<div class="modal-body">
					...
					<div class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control name" name="updateParam" id="name"/>
								<input type="hidden" class="form-control id" name="updateParam" id="id"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2">理论返奖</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="utheory" value="2000"   />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2">返奖率</label>
							<div class="col-sm-4">
								<input type="text" class="form-control rebates umoney" name="updateParam" id="rebates"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control payoutRatio umoney" name="updateParam" id="payoutRatio"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control margin umoney" name="updateParam" id="margin"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control remark" name="updateParam" id="remark"></textarea>
							</div>
						</div>
					</div>
				</div>
