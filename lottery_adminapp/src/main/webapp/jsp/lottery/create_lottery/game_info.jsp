			...
			<div class="panel-body">
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						...
						<input type="button" class="btn btn-primary" onclick="playForm.submitForm()" value="下一步" > 
						<a href="${contextPath }/lottery/initLotteryIssue.do" class="btn btn-link btn-sm">返回</a>
					</div>
				</div>
			</div>
		</div>
