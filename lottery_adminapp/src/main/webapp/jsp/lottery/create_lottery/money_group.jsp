			...
			<div class="panel-body">
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<input type="button" class="btn btn-primary" value="下一步" onclick="bonusForm.submitForm();"> 
						<a href="${contextPath }/lottery/initLotteryPlayModel.do" class="btn btn-link btn-sm">返回</a>
					</div>
				</div>
			</div>
		</div>
